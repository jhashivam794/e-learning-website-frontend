...
<section class="form-container">
   ...
   <form class="register" action="" method="post" enctype="multipart/form-data">
      <div style="text-align: center;"><a href="index.php"><img src="images/logo.jpg" alt="Image" width="170" height="75" class="img-fluid"></a></div>
      </div>
      ...
      <div class="flex">
         ...
         <div class="col">
            ...
            <input type="password" name="cpass" placeholder="confirm your password" maxlength="40" required class="box">
         </div>
      </div>
